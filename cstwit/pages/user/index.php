    ...
    <main class="app-main">
      <div class="app-content-header">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <h3 class="mb-0 text-danger-subtle fw-bold fs-1">News Feed</h3>
            </div>
          </div>
        </div>
      </div>
      <div class="app-content">
        <div class="container-fluid">
          ...
          ?>
          <form action="/cstwit/pages/user/api/createpost" method="POST" class="needs-validation" novalidate>
              ...
              <div class="card mb-3">
                ...
                <div class="card-footer">
                  <div class="d-flex justify-content-start align-items-center gap-3">
                    <!-- Like Button -->
                    <form action="/cstwit/pages/user/api/like_post" method="POST" class="d-inline">
                ...
                <!-- BOOK NOW Modal -->
                <div class="modal fade" id="reportPostModal" tabindex="-1" aria-labelledby="reportPostModal"
                  aria-hidden="true">
                  <div class="modal-dialog">
                    <div class="modal-content">
                      <div class="modal-header">
                        <h5 class="modal-title" id="reportPostModallLabel">Report Post</h5>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                      </div>
                      <form action="/cstwit/pages/user/api/report_post" method="POST" class="needs-validation" novalidate>
                        <div class="modal-body">
                          <input type="hidden" name="post_id" value="<?php echo (int) $post['id']; ?>">
                          <input type="hidden" name="user_id" value="<?php echo userID(); ?>">
                          <label for="insurance" class="form-label fw-bold text-danger-subtle">Reason</label>
                          <select class="form-select py-2 rounded-3" id="reason" name="reason" required>
                            <option value="" disabled selected hidden></option>
                            <option value="Spam" class="select">Spam</option>
                            <option value="Abusive or harmful" class="select">Abusive or harmful</option>
                            <option value="Self-harm or suicide" class="select">Self-harm or suicide</option>
                            <option value="Misleading information" class="select">Misleading information</option>
                            <option value="Sensitive media" class="select">Sensitive media</option>
                            <option value="Intellectual property violation" class="select">Intellectual property violation
                            </option>
                            <option value="Private information" class="select">Private information</option>
                            <option value="Terrorism or violent extremism" class="select">Terrorism or violent extremism
                            </option>
                            <option value="Child sexual exploitation" class="select">Child sexual exploitation</option>
                          </select>
                        ...
                        <div class="modal-footer">
                          ...
                          <button type="submit" class="btn btn-danger-subtle">Report</button>
                        </div>
                      </form>
                    </div>
                  </div>
                ...
                <div class="col-12 px-3">
                  <div id="comments-<?php echo (int) $post['id']; ?>" class="mt-2" style="display: none;">
                    ...
                    <!-- Add Comment Form -->
                    <form action="/cstwit/pages/user/api/add_comment" method="POST" class="my-3">
                      <input type="hidden" name="post_id" value="<?php echo (int) $post['id']; ?>">
                      <input type="hidden" name="user_id" value="<?php echo userID(); ?>">
