    ...
    <main class="app-main">
      <div class="app-content-header">
        <div class="container-fluid">
          <div class="row">
            <div class="col-sm-6">
              <h3 class="mb-0 text-danger-subtle fw-bold fs-1">Dashboard</h3>
            </div>
            <div class="col-sm-6">
                ...
                <div class="card border-left-info shadow h-100 py-2">
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs fw-bold text-danger-subtle text-uppercase mb-1">
                          TOTAL POSTS</div>
                        <div class="h1 mb-0 fw-bold text-danger-subtle">
                      ...
                      <div class="col-auto">
                        <i class="bi bi-stickies fs-1 text-danger-subtle"></i>
                      </div>
                    </div>
                  </div>
                </div>
                  ...
                  <div class="card-body">
                    <div class="row align-items-center">
                      <div class="col mr-2">
                        ...
                        <div class="row align-items-center">
                          <div class="col-auto">
                            <div class="h1 mb-0 mr-3 fw-bold text-danger-subtle">
                              <span class="info-box-number"><?php
                      ...
                      <div class="col-auto">
                        <i class="bi bi-people fs-1 text-danger-subtle"></i>
                      </div>
                    </div>
                  </div>
                </div>
